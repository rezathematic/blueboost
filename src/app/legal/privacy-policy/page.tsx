...
export const metadata: Metadata = {
  ...
  description: 'Blue Boost privacy policy'
}

const links = [
  { href: '/legal/privacy-policy', name: 'Privacy Policy', current: true }
]
    ...
    <>
      ...
      <section className="bg-white py-24 sm:py-32">
        <div className="container mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <article className="prose-quoteless prose prose-lg prose-neutral mx-auto mt-10 border-t border-gray-200 pt-10 sm:mt-16 sm:pt-16 lg:mx-0 lg:max-w-none">
            ...
            <ul>
              ...
              <li>
                <p>
                  ...
                  Company&quot;, &quot;We&quot;, &quot;Us&quot; or
                  &quot;Our&quot; in this Agreement) refers to Feature
                  Engineering Private Limited, Prestige Atlanta, 80 Feet Rd,
              ...
              <li>
                <p>
                  <strong>Website</strong> refers to Blue Boost, accessible from{' '}
                  <a href="https://blueboost.co">https://blueboost.co</a>
                </p>
              </li>
              <li>
                <p>
            ...
            <ul>
              <li>By email: privacy [at] lueboost.co</li>
            </ul>
          </article>
        </div>
      </section>
